            ...
            while (continueloop == 0) {
                ...
                stage("Executing ${commandsArray[commandCounter]}") {
                    ...
                    try {
                        ...
                        echo "commandsArray.size ${commandsArray.size()}"
                        echo "commandCounter ${commandCounter}"
                        echo "commandSucessful ${commandSucessful}"
                        echo "continueloop ${continueloop}"
                    ...
                    if (commandSucessful == 0) {
                        ...
                        if (commandsArray.size() == (commandCounter-1)){
